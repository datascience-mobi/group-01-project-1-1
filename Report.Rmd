...
fviz_nbclust(ceres.clean, kmeans, method = "silhouette")

km2= kmeans(x= ceres.clean, centers = 2, nstart = 25)
km3= kmeans(x = ceres.clean, centers = 3, nstart = 25)
km4= kmeans(x= ceres.clean, centers = 4, nstart = 25)
table(km_CERES$cluster)

p2 = fviz_cluster(km2, geom = "text", labelsize = 8, data = ceres.clean) + ggtitle("k = 2")
p3 = fviz_cluster(km3, geom = "text", labelsize = 8, data = ceres.clean) + ggtitle("k = 3")
p4 = fviz_cluster(km4, geom = "text", labelsize = 8, data = ceres.clean) + ggtitle("k = 4")

s2=plot(silhouette(km2$cluster, dist(ceres.clean)), border = NA, main = "Silhouette values for 2 clusters")
s3=plot(silhouette(km3$cluster, dist(ceres.clean)), border = NA, main = "Silhouette values for 3 clusters")
s4=plot(silhouette(km4$cluster, dist(ceres.clean)), border = NA, main = "Silhouette values for 4 clusters")
...
Observation: the training/test set splitting did not work for the copy number matrix. The dimensions of the test set were not right. We had 2541 values instead of the 2309 we needed, which represent one fifth of the original multiple linear regression matrix.
