...
In the next step we generated a correlation matrix including the correlation coefficients between all genes in the matrix and isolated the correlation coefficients between all genes and our DM.
...
The matrices for the other DMs were created using an analogous method.
