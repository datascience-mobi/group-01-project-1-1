...
Goal of k means clustering is grouping of similar objects together in one specific cluster. Potential SSTs as well as our selected driver mutations should therefore be part of the same cluster. TP53, PTEN and MUC-16 are all part of cluster 2, so potential SSTs which belong to cluster 1 are removed.
