...
We then selected the columns (CERES score of on gene across all cell lines) and calculated the correlation to the DM (one specific column). We oerformed this for all genes in the matrix using lapply.

Examplary correlation test for one specific gene:
```
