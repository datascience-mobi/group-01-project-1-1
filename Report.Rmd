...
We could not assign our cell lines to a specific subtype of GBM. We would assign them more the proneural or mesenchymal GBM subtypes, because of the TP53 and PTEN mutations, which are markers for these subtypes. However, these were the only known markers for these two subtypes that we could identify in our cell lines.
