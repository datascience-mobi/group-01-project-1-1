...
2. We visualized the gene´s distribution for all four matrices:
  a. The majority of the genes shows normal to moderate expression levels. However, a *few genes are highly overexpressed* (marked in red). 
  ...
  c. The majority of genes show no significant
